create table C##MYUSER.TRANSACTIONS (
...
BEFORE INSERT OR UPDATE ON C##MYUSER.TRANSACTIONS
...
begin
  while 1 = 1
  loop
    insert into C##MYUSER.TRANSACTIONS (amount,account_type_origin,id_origin,account_type_destination,id_destination) 
