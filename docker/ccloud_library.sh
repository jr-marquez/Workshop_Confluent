...
function ccloud::maybe_create_and_use_environment() {
  ...
  if [[ -z "$ENVIRONMENT" ]];
  then
    ENVIRONMENT=$(ccloud::create_and_use_environment $ENVIRONMENT_NAME $ENVIRONMENT)
...
function ccloud::create_ccloud_stack() {
  ...
  ENVIRONMENT=$(ccloud::maybe_create_and_use_environment "$ENVIRONMENT_NAME" "$ENVIRONMENT")
