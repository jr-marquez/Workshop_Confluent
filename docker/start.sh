...
ccloud::create_ccloud_stack false $CLUSTER_NAME $CLUSTER_CLOUD $CLUSTER_REGION $ENVIRONMENT_NAME $ENVIRONMENT \
	&& print_code_pass -c "ccloud::create_ccloud_stack false $CLUSTER_NAME $CLUSTER_CLOUD $CLUSTER_REGION $ENVIRONMENT_NAME $ENVIRONMENT"
